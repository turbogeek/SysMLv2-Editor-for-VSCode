...
implicitFeatureDeclaration
    : declarationName EQUALS expression SEMICOLON
    ;
...
effectClause
    ...
    | DO SEND expression (VIA expression)? (TO expression)?
    | DO expression
    ;
...
thenStatement
    ...
    | THEN ACCEPT usageName? featureRelationships? (VIA expression)? acceptTiming? SEMICOLON?
...
relationalExpression
    : extentExpression ((LT | GT | LE | GE) extentExpression)*
    ;
